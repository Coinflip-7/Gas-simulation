...
/**
 * Write a description of class Sensor2 here.
 * 
 * @author (your name) 
...
public class Sensor2 extends Actor implements Closeable {
    ...
    public Sensor2(Siren siren, Phone phone) throws IOException{
    ...
    if (!particulas.isEmpty()) {
        ...
        if (concentracion >= umbralConcentracion) {
            ...
            jsonMessage.put("Origin", "sensor2");
